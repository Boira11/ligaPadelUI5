		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Padel Master Detail",
									"targetURL": "#padelmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"padelmasterdetail-display": {
								"semanticObject": "padelmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=padelmasterdetail",
									"url": sap.ui.require.toUrl("padelmasterdetail")
								}
							}
						}
					}
